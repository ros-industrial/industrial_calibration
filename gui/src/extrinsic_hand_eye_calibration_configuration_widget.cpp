...
ExtrinsicHandEyeCalibrationConfigurationWidget::ExtrinsicHandEyeCalibrationConfigurationWidget(QWidget* parent)
    : QWidget(parent)
    , ui_(new Ui::ExtrinsicHandEyeCalibrationConfiguration())
{
    ui_->setupUi(this);
...
ExtrinsicHandEyeCalibrationConfigurationWidget::~ExtrinsicHandEyeCalibrationConfigurationWidget()
{
    delete ui_;
}
...
void ExtrinsicHandEyeCalibrationConfigurationWidget::save()
{
    ...
    {
        // Get filepath
        const QString file = QFileDialog::getSaveFileName(this, "Save calibration configuration", QString(), "YAML files (*.yaml *.yml)");
