...
bool RobocylCalService::executeCallBack(intrinsic_cal::rail_ical_run::Request& req,
    ...
    if (camera_->camera_observer_->getObservations(camera_observations))
    {
      ...
      else
      {
        ...
        for (int j = 0; j < num_observations; j++)
        {
          ...
          problem.AddResidualBlock(cost_function[q], NULL, camera_->camera_parameters_.pb_intrinsics,
